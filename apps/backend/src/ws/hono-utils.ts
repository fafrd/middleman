...
export function createCorsMiddleware(allowMethods: readonly string[]): MiddlewareHandler<NodeServerEnv> {
  return cors({
...
export function createMethodGuard(allowMethods: readonly string[]): MiddlewareHandler<NodeServerEnv> {
