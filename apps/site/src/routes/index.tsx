      ...
      <div className="mx-auto max-w-[68rem] px-6 sm:px-10 lg:px-16">
        ...
        <main id="main">
          ...
          <section className="py-20 sm:py-24" aria-labelledby="problem-heading">
            <h2 id="problem-heading" className="text-[11px] font-medium tracking-[0.14em] text-muted uppercase">
              The Problem
            </h2>
            ...
            <div className="mt-8 max-w-2xl space-y-5">
              ...
              <p className="text-[1.05rem] leading-[1.7] text-ink text-pretty">
                ...
                sticks around. You tell it what needs to get done&thinsp;&mdash;&thinsp;it dispatches
          ...
          <section className="py-20 sm:py-24" aria-labelledby="how-heading">
            <h2 id="how-heading" className="text-[11px] font-medium tracking-[0.14em] text-muted uppercase">
              How It Works
            </h2>
            ...
            <ol className="mt-12 grid gap-10 sm:grid-cols-3 sm:gap-x-16 list-none p-0">
              {flow.map((step) => (
                <li key={step.title}>
                  <p className="text-[11px] font-medium tracking-[0.14em] text-muted/50 uppercase" aria-hidden="true">
                    Step&nbsp;{step.step}
                  </p>
          ...
          <section className="py-20 sm:py-24" aria-labelledby="capabilities-heading">
            <h2 id="capabilities-heading" className="text-[11px] font-medium tracking-[0.14em] text-muted uppercase">
              Capabilities
            </h2>
          ...
          <section id="quick-start" className="py-20 sm:py-24" aria-labelledby="quickstart-heading">
            <h2 id="quickstart-heading" className="text-[11px] font-medium tracking-[0.14em] text-muted uppercase">
              Quick Start
            </h2>

            <div className="mt-12 overflow-hidden rounded-xl bg-ink" role="region" aria-label="Quick start terminal commands">
            ...
            <p className="mt-5 text-[13px] text-muted">
              Opens at{' '}
              <span className="text-ink font-medium">localhost:47188</span>. Create a
