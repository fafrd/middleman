...
export type ConversationMessageEntry = Extract<ConversationEntry, { type: "conversation_message" }>;
export type ConversationLogEntry = Extract<ConversationEntry, { type: "conversation_log" }>;
export type AgentMessageEntry = Extract<ConversationEntry, { type: "agent_message" }>;
export type AgentToolCallEntry = Extract<ConversationEntry, { type: "agent_tool_call" }>;
...
export type ToolDisplayStatus = "pending" | "completed" | "cancelled" | "error";
